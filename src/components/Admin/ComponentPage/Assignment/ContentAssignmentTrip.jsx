...
import TableAssignmentTrip from './TableAssignmentTrip';
...
const breadcrumbItems = [
  ...
  { label: 'Danh sách phân công chuyến', className: 'text-3xl font-bold' },
];

const ContentAssignmentTrip = ({ assignmentTrips, totalResults }) => {
  return (
    <div className="content-trip">
      ...
      {assignmentTrips && assignmentTrips.length > 0 ? (
        <TableAssignmentTrip assignmentTrips={assignmentTrips} />
      ) : (
        <p>Không có xe nào.</p>
      )}
    </div>
...
export default ContentAssignmentTrip;
